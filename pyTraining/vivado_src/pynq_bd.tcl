...
proc create_root_design { parentCell } {
  ...
  set GN_inference_0 [ create_bd_cell -type ip -vlnv Fabian:hls:GN_inference:1.2 GN_inference_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.FIFO_IN_DEPTH {161} \
    CONFIG.FIFO_IN_DWIDTH {32} \
    CONFIG.FIFO_IN_ENA {true} \
    CONFIG.FIFO_OUT_DEPTH {161} \
...
\
  ...
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins GN_inference_0/input_r_TVALID] [get_bd_pins comblock_0/fifo_valid_o]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs comblock_0/AXIL/AXIL] -force
  ...
  set_property PFM_NAME {xilinx:pynq-z1:inference:1.2} [get_files [current_bd_design].bd]
